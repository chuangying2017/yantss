<template>
  <div class="search-bar">
    ...
    <div class="u-table" v-show="!$loadingRouteData && items.length">
  ...
  export default {
    ...
    methods: {
      search: function () {
        ...
        this.$http.get('/staffs/preorders?keyword=' + this.phone).then(
          function (data) {
      ...
      loadmore: function () {
        ...
        this.$http.get('/staffs/preorders?page=' + (this.currentPage + 1) + '&keyword=' + this.phone).then(
          function (data) {
