<template>
  ...
  <ul class="m-list m-list-select m-list-full">
    <!--<li>-->
    <!--<input type="radio" id="pay1" v-model="channel" value="upacp_wap">-->
    <!--<label for="pay1">-->
    <!--<i class="iconfont u-pay-icon card">&#xe646;</i>网银支付-->
    <!--<div class="fr">-->
    ...
    <!-- <li>
        <input type="radio" id="pay3" v-model="channel" value="alipay_wap">
        <label for="pay3">
          <i class="iconfont u-pay-icon alipay">&#xe63c;</i>支付宝
          <div class="fr">
              <i class="iconfont uncheck">&#xe607;</i>
              <i class="iconfont checked">&#xe604;</i>
          </div>
