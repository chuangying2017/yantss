<template>
  <div class="coupon-activity">
    <div class="m-coupons game">
      <img src="https://ocie5114k.qnssl.com/image/logo.png" alt="" class="cover">
      <div class="panel">
...
<script>
  ...
  export default{
    ...
    route: {
      data: function () {
        return this.$http.get('/promotions/coupons/15').then(
          function (data) {
            var arr = []
    ...
    ready: function () {
      var dataForWeixin = {
        ...
        messagelink: 'http://yt.l43.cn/yt-client/?#!/coupons/activity?utm_source=app_share_coupon',
        desc: '一大波优惠券袭来,点击马上领取优惠券,享受优鲜达更多优惠活动'
      }
...
<style lang="scss">
  ...
  .m-coupons.game {
    background-image: url(https://ocie5114k.qnssl.com/image/bg.jpg);
