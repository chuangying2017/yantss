<template>
  ...
  <ul v-show="!$loadingRouteData && orders.length">
    <li v-for="order in orders" class="m-milkcard">
      ...
      <div class="body">
        <div v-for="sku in order.skus" class="milk-list">
          <div class="pure-g">
            <div class="pure-u-1-6">
              <div class="img-wrap">
                <img :src="sku.cover_image" alt="" width="50" height="50">
              </div>
            </div>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1-3">
              <p class="tr"><span class="highlight">{{order.start_time}}</span></p>
            </div>
          </div>
        </div>
  ...
  <div class="notice" v-show="!$loadingRouteData && orders.length">
    <h1>温馨提示:</h1>
    <ul>
  ...
  <p class="item-info" v-show="orders.length">* 如订单24小时内未受理,请致电: <a class="phone-link" href="tel:400-888-1956">400-888-1956</a>
  </p>
