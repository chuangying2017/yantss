                        ...
                        <table class="table table-hover table-striped goodsTable">
                          ...
                          <!--<tr v-for="order in orders">-->
                            ...
                            <td>
                              <div class="spCon">
                                <div class="imgCon">
                                  <img class="imgC" src="http://o7tep4eu1.bkt.clouddn.com/FmWiM8n3aO30lRnz_Uy_102vsx0d-201706211511233587"/>
                                </div>
                                <div>
                                  <p>[礼品]</p>
                            ...
                            <td>0/6</td>
                            <td>
                              <button type="button" class="btn">推荐</button>
                              <button type="button" class="btn">启动</button>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <!--<tr v-for="order in orders">-->
                            <td><input type="checkbox" class="checkC" value="1"/></td>
                            <td>1</td>
                            <td>
                              <div class="spCon">
                                <div class="imgCon">
