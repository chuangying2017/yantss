<template>
  <div class="row">
    <div class="col-md-6">
      <a v-link="{path: '/dashboard/integral/create'}" class="btn btn-social btn-google btn-sm mb20">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-striped">
            ...
            <tr v-for="banner in banners">
              ...
              <td>
                <a v-link="{path: '/dashboard/integral/detail/' + banner.id}">编辑</a>
...
<script>
  ...
  export default {
    ...
    route: {
      data () {
        return {
          banners: api.banners.list({params: {'type': 'integral'}})
        }
      }
    },
    methods: {
