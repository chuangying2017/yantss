        ...
        <div class="row bw">
          <div class="col-md-8">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">活动消耗</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" v-model="product.tags">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">统一邮费</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" v-model="product.tags">
                </div>
                <div class="col-sm-4">
