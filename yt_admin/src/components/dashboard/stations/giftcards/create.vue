            ...
            <div class="col-md-6">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" number class="form-control" v-model="giftcard.effect_days">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" number class="form-control" v-model="giftcard.total">
                  </div>
                </div>
                <div class="form-group">
  ...
  export default {
    ...
    methods: {
      ...
      submit () {
        ...
        api.giftcards.create(this.giftcard).then(function (data) {
          window.alert('创建成功!')
