                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <select class="select mb20" v-model="residence.district_id">
                          ...
                          <option v-for="district in districts" :value="district.id" :selected="residence.district_id === district.id">{{district.name}}</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
...
<script>
  ...
  export default {
    ...
    route: {
      data ({to: {params: {residence_id}}}) {
        return {
          residence: api.residences.get(residence_id),
    ...
    methods: {
      submit () {
        var self = this
        api.residences.update(this.residence).then(function (da) {
          window.alert('修改成功!')
